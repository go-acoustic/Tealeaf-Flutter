...
public class TlFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        FlutterEngineCache.getInstance().put("tealeaf_cache_engine", flutterPluginBinding.getFlutterEngine());

        flutterRenderer.addIsDisplayingFlutterUiListener(new FlutterUiDisplayListener() {
            @Override
            public void onFlutterUiDisplayed() {
                // Set Flutter Engine, when UI is visible
                //Tealeaf.setFlutterEngine(new WeakReference<FlutterEngine>(flutterPluginBinding.getFlutterEngine()));
            }
        ...
        new Tealeaf((Application) flutterPluginBinding.getApplicationContext());
        Tealeaf.enable();
    }
