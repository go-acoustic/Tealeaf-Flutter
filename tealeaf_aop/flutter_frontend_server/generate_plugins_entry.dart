...
int main(List<String> args) {
  ...
  if (needRegenerate) {
    ...
    for (int i = 0; i < pluginCnt; i++) {
      ...
      aspectdContent =
          '${aspectdContent}export \'package:tl_flutter_plugin/src/plugins/$pluginItem/$pluginItem.dart\';\n';
    }
    ...
    for (int i = 0; i < pluginCnt; i++) {
      ...
      transformerWrapperImport =
          '${transformerWrapperImport}import \'package:tl_flutter_plugin/src/plugins/$pluginItem/${pluginItem}_transformer_wrapper.dart\';\n';
